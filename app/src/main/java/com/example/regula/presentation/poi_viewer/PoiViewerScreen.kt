...
import com.example.regula.PermissionsRequest
    ...
    Column(
        ...
        Row(
            ...
            Column {
                ...
                Text(
                    text = viewModel.isInCircleDistance, modifier = Modifier.background(Color.White)
                )
            }
            ReadinessIndicator(
        ...
        Row(
            ...
            Text(
                modifier = Modifier.background(Color.White), text = viewModel.currentPointName
            )
        }
        Row(
